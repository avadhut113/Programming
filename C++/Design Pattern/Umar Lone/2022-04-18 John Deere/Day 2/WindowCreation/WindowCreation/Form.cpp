...
Form::Form(LPCWSTR lpClassName, LPCSTR lpWindowName, int X, int Y) :Form{
		lpClassName, lpWindowName, X,Y, CW_USEDEFAULT, CW_USEDEFAULT,  nullptr, nullptr, nullptr, nullptr
} {
}

Form::Form(LPCWSTR lpClassName, LPCSTR lpWindowName, int X, int Y, int nWidth, int nHeight):Form{
		lpClassName, lpWindowName, X,Y, nWidth, nHeight,  nullptr, nullptr, nullptr, nullptr
} {
}

FormBuilder & FormBuilder::SetDwExStyle(DWORD dwExStyle) {
	this->dwExStyle = dwExStyle;
	return *this ;
}

FormBuilder & FormBuilder::SetLpClassName(LPCWSTR lpClassName) {
	this->lpClassName = lpClassName;
	return *this ;
}

FormBuilder & FormBuilder::SetLpWindowName(LPCSTR lpWindowName) {
	this->lpWindowName = lpWindowName;
	return *this ;
}

FormBuilder & FormBuilder::SetStyle(DWORD dwStyle) {
	this->dwStyle = dwStyle;
	return *this ;
}

FormBuilder & FormBuilder::SetX(int x) {
	X = x;
	return *this ;
}

FormBuilder & FormBuilder::SetY(int y) {
	Y = y;
	return *this ;
}

FormBuilder & FormBuilder::SetNWidth(int nWidth) {
	this->nWidth = nWidth;
	return *this ;
}

FormBuilder & FormBuilder::SetNHeight(int nHeight) {
	this->nHeight = nHeight;
	return *this ;
}

FormBuilder & FormBuilder::SetHWndParent(HWND hWndParent) {
	this->hWndParent = hWndParent;
	return *this ;
}

FormBuilder & FormBuilder::SetHMenu(HMENU hMenu) {
	this->hMenu = hMenu;
	return *this ;
}

FormBuilder & FormBuilder::SetHInstance(HINSTANCE hInstance) {
	this->hInstance = hInstance;
	return *this ;
}

FormBuilder & FormBuilder::SetLpParam(LPVOID lpParam) {
	this->lpParam = lpParam;
	return *this ;
}

Form FormBuilder::Build() {
	return Form{dwExStyle, lpClassName, lpWindowName, dwStyle, X, Y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam} ;
}
